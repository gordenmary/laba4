...
<body>
    ...
    <section class= "featured_plants">
        ...
        <div>
            ...
            <a href="create.php">Создать новый товар</a>
            <div class= "plant_items">
                ...
                <?php foreach($xml->item as $item) { ?>
                    ...
                    <div class= "plant_item">
                        ...
                        <a class="text" href="change.php?id=<?php echo $item['id'] ?>">Изменить товар</a>
                        <br>
                        <a class ="text" href="delete.php?id=<?php echo $item['id'] ?>">Удалить товар</a>
                        <br>
